...
# Fly.io...) -- pas pour Vercel : voir la note dans README.md sur pourquoi
# les fonctions serverless de Vercel ne conviennent pas a la persistance par
# fichiers JSON (progress.py/settings.py/sessions.py). N'installe QUE ce
# dont l'API a besoin (pas streamlit/altair, reserves a app.py).
